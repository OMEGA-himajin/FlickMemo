...
- [x] 1. 開発基盤セットアップ（Flutter/Riverpod/Drift/通知プラグイン）
...
- [x] 2. データレイヤ実装（Driftテーブル＋Repository）
...
- [x] 4. アプリケーションサービス・エントリ統合
- [x] 4.1 EntryDispatcher 実装
